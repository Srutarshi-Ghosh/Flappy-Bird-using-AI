...
def draw_window(surf, birds, pipes, base, score, gen):
    ...
    text = STAT_FONT.render("Generation: " + str(gen), 1, (WHITE))
...
def main(genomes, config):
    ...
    while run and len(birds) > 0:
        ...
        if score > 100:
            pickle.dump(nets[0], open('Flappy_Bird.pickle', 'wb'))
            break
...
if __name__ == "__main__":
    ...
    config_path = os.path.join(local_dir, "Flappy_Bird_config.txt")
    run(config_path)
